...
def btnprs(btn):
    ...
    if btn == 'btn8':
        ...
        for i in range(tlon):
            ...
            fxent.grid(row=2 + tn + 1 + te + 1 + 1 + 2 * tsupn + 1 + 1 + count + 1, column=1, columnspan=2,
                       sticky='nsew')
            fyent.grid(row=2 + tn + 1 + te + 1 + 1 + 2 * tsupn + 1 + 1 + count + 2, column=1, columnspan=2,
                       sticky='nsew')
    ...
    if btn == 'btn9':
        ...
        btn10.grid(row=2 + tn + 1 + te + 1 + 1 + 2 * tsupn + 1 + 1 + 3 * tlon + 1, column=0, columnspan=3,
                   sticky='nsew')
